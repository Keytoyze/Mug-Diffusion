...
class MelspectrogramEncoder(nn.Module):
    def __init__(self, *, n_freq, middle_channels, out_channels,
                 channel_mult, num_res_blocks, **ignore_kwargs):
        super().__init__()
...
if __name__ == '__main__':
    ...
    torchsummary.summary(
        MelspectrogramEncoder(n_freq=128, middle_channels=32, out_channels=32,
                              num_res_blocks=1, channel_mult=[1, 1, 2, 2, 2, 4, 4]),
        [
            (128, 16384),
        ],
